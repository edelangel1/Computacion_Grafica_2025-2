...
int main()
{
    ...
    GLFWwindow* window = glfwCreateWindow(WIDTH, HEIGHT, "SkyBox - Eduardo Del Angel", nullptr, nullptr);
...
void Animation() {
	...
	if (dogAnim == 1) {		// Walk Animation
		...
		// Definir el l�mite del piso 
		const float floorEnd = 2.3f; // El perro se detendr� antes de llegar a esta posici�n en Z

		// Solo animar si no se ha llegado al l�mite
